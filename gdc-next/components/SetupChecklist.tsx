          ...
          return (
            <Fragment key={s.id}>
              ...
              >
                ...
                <span style={{ fontFamily: 'var(--body)', fontSize: '.66rem', lineHeight: 1, color: labelColor, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '.04em', textDecoration: 'underline', textUnderlineOffset: '3px' }}>{s.label}</span>
