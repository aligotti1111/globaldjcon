...
.gdc-landing .plan.free{--accent:#cfd6d4;background:#20232a}
...
<section id="features">
  <div class="wrap">
    ...
    <div class="flist">
      ...
      <div class="r reveal"><img loading="lazy" decoding="async" src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_9832a838-15f6-4770-be32-2edcc0b10107.png" alt=""><h3>Balance</h3><p>The balance is auto‑calculated after the deposit and sent to the host in one click. Once it's marked paid, a receipt is emailed to the host automatically. <b>For mobile DJs:</b> if overtime is added to your event, you can send it separately — a total receipt covering the event and the overtime is sent once it's marked paid.</p></div>
    ...
    <div class="price bill-mo">
      ...
      <div class="plan starter reveal">
        ...
        <ul>
          ...
          <li class="hot"><svg viewBox="0 0 24 24" stroke-width="2.4"><path d="M20 6 9 17l-5-5"/></svg> 10 photos</li>
      ...
      <div class="plan pro reveal">
        ...
        <ul>
          ...
          <li class="hot"><svg viewBox="0 0 24 24" stroke-width="2.4"><path d="M20 6 9 17l-5-5"/></svg> 100 photos</li>
      ...
      <div class="plan premium reveal">
        ...
        <ul>
          ...
          <li class="hot"><svg viewBox="0 0 24 24" stroke-width="2.4"><path d="M20 6 9 17l-5-5"/></svg> 350 photos + albums</li>
      ...
      <div class="plan enterprise reveal">
        ...
        <ul>
          ...
          <li class="hot"><svg viewBox="0 0 24 24" stroke-width="2.4"><path d="M20 6 9 17l-5-5"/></svg> 1000 photos + albums</li>
