...
<div class="searchbar">
  <div class="wrap">
    ...
    <button class="searchbtn" type="button" aria-label="Use my location" onclick="location.href='/djs'">
