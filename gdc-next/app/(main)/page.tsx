...
const LANDING_CSS = String.raw`@import url('https://fonts.googleapis.com/css2?family=Bebas+Neue&family=DM+Sans:wght@400;500;600;700&family=Space+Mono:wght@400;700&display=swap');
.gdc-landing{
...
<section id="features">
  <div class="wrap">
    ...
    <div class="flist">
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_351e51b1-cf96-42a8-ae49-b8f568baabea.png" alt=""><h3>DJ Profile</h3><p>Your public profile is your home base on Global DJ Connect — hosts and clubs find you in the directory, see your info, availability and bookings, and book you directly. All club/bar bookings display on your profile, with the option to add a URL for more info. Share your profile link anywhere.</p></div>
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_351e51b1-cf96-42a8-ae49-b8f568baabea.png" alt=""><h3>Instant quotes</h3><p>Host picks event type, date, time and venue, and your pricing builds the quote automatically — the details and quote are then sent to you for approval. Prefer not to display prices? Turn on "request a price" instead: the host enters their info and selects their requirements, and a booking request is emailed to you to add a price.</p></div>
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260902_073219_a8d7f0f0-f682-4cf4-9414-a8e7a82d39ea.png" alt=""><h3>Contracts &amp; e‑sign</h3><p>Built‑in e‑sign system. Upload your own contract and set the fields once — with each booking, our system auto‑populates the booking's details onto the contract, ready for you to approve and send in one click. No contract? Work off Global DJ Connect's pre‑built contracts. Once signed, both parties are emailed a copy.</p></div>
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_9832a838-15f6-4770-be32-2edcc0b10107.png" alt=""><h3>Deposits</h3><p>Set the deposit % you require in booking settings. Global DJ Connect calculates the deposit for each booking — click Request Deposit in your dashboard and the host is emailed a request with every payment option you accept.</p></div>
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_6dbc45c3-62c6-49e3-b040-e63dca786535.png" alt=""><h3>Get paid</h3><p>We don't middle‑man your deposits or balances. Money is sent directly to your account and we never take a % of the transaction. Note: depending on the method, the payment processor may charge its own transaction fee.<span class="paylist"><b class="pm-stripe">Credit card</b><i>·</i><b class="pm-paypal">PayPal</b><i>·</i><b class="pm-venmo">Venmo</b><i>·</i><b class="pm-cashapp">Cash App</b><i>·</i><b class="pm-check">Check</b><i>·</i><b class="pm-cash">Cash</b></span></p></div>
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_351e51b1-cf96-42a8-ae49-b8f568baabea.png" alt=""><h3>Manual booking</h3><p>Booked a gig off‑platform? Add it with one click — enter the date, venue and rate and it drops alongside your online bookings. From there you can add the host's email, send a contract, request a deposit, invoice. The manual booking will act just as a normal booking through the platform.</p></div>
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_090555_9783c217-7752-446f-b96e-871e543cdac6.png" alt=""><h3>Discounts &amp; promo codes</h3><p>Create promo codes with a % off or exact dollar amount, or set a site‑wide % discount off all bookings. Includes an exclusion option for select dates (e.g. New Year's Eve).</p></div>
      <div class="r reveal framed"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084917_664ddc37-4986-4420-ab8e-10d1889ac023.png" alt=""><div class="titlecol"><span class="tg mobile">Mobile DJ only</span><h3>Planner &amp; playlist</h3></div><p>Customize a planner for each event and send it with one click for all future events. It auto‑saves the moment the host starts filling it in, so they don't have to do it all at once. Track the total % complete to the minute from your booking dashboard, and send a reminder email any time.</p></div>
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_9832a838-15f6-4770-be32-2edcc0b10107.png" alt=""><h3>Invoicing</h3><p>The balance is auto‑calculated after the deposit and invoiced to the host in one click. Once it's marked paid, a receipt is emailed to the host automatically. <b>For mobile DJs:</b> if overtime is added to your event, you can invoice it separately — a total receipt covering the event and the overtime is sent once it's marked paid.</p></div>
      <div class="r reveal framed-amber"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_83fb9f5b-de14-4737-9b42-a37962810cd2.png" alt=""><div class="titlecol"><span class="tg club">Club/Bar DJ only</span><h3>Rider</h3></div><p>Send the host / promoter your technical &amp; hospitality rider. Customize it within Global DJ Connect, or upload a pre‑made rider — either way it sends straight through Global DJ Connect.</p></div>
      <div class="r reveal framed-amber"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_27083888-d22d-4bb4-9149-ef297714a195.png" alt=""><div class="titlecol"><span class="tg club">Club/Bar DJ only</span><h3>Guest list</h3></div><p>Add and sort the guest list, then send it to the host through Global DJ Connect so they can confirm names have been approved.</p></div>
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_d83ad708-0d07-45a7-ba99-fb6fdbc21b09.png" alt=""><h3>Calendar sync</h3><p>Connect all bookings to your Google or Apple calendar with "Sync to Calendar." Once synced, all existing and future bookings are added to your calendar automatically.</p></div>
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_d83ad708-0d07-45a7-ba99-fb6fdbc21b09.png" alt=""><h3>Embed calendar</h3><p>Embed your live availability calendar on your own website — clients see your open and booked dates in real time.</p></div>
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260830_083159_d9cea88f-a41f-45fd-88eb-92c421afd6eb.png" alt=""><h3>Team</h3><p>Give authorized personnel access to your Global DJ Connect account with separate logins and role‑based restrictions — Assistant, Manager, or Admin. <a class="samplelink" onclick="openLB('lbTeamMobile')">Mobile DJ account sample</a> · <a class="samplelink club" onclick="openLB('lbTeamClub')">Club/Bar DJ account sample</a></p></div>
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_85726c22-c72e-478d-9d61-4f1981265900.png" alt=""><h3>SMS &amp; Email</h3><p>By default every request sends an email update; opt in for SMS notifications as a secondary reminder.</p></div>
      <div class="r reveal"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_3I7KWF53YRk0UtD2aF2XnRfCPCI/hf_20260826_084816_9832a838-15f6-4770-be32-2edcc0b10107.png" alt=""><h3>Past bookings</h3><p>Every completed event moves to your past bookings, keeping a full record — contract, planner or rider, guest list, and receipts all stay attached. Re‑download any document, invoice overtime after the fact, or reference past details when a repeat client books again.</p></div>
    </div>
  </div>
</section>
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <div className="gdc-landing" dangerouslySetInnerHTML={{ __html: LANDING_BODY }} />
    </>
  );
}
