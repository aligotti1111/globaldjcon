  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.editHint}>
        <span aria-hidden="true"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 5v14M5 12h14" /><path d="M9 8 12 5l3 3" /><path d="M9 16 12 19l3-3" /><path d="M8 9 5 12l3 3" /><path d="M16 9 19 12l-3 3" /></svg></span> Drag to reorder. Tap a question or its pencil to
      ...
      <div className={styles.addTop}>
        ...
        >
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 5v14M5 12h14" /><path d="M9 8 12 5l3 3" /><path d="M9 16 12 19l3-3" /><path d="M8 9 5 12l3 3" /><path d="M16 9 19 12l-3 3" /></svg> Add Section Title
        </button>
        <button
          type="button"
          ...
          title="Drag onto a spot in the list, or click to add at the top"
        >
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 5v14M5 12h14" /><path d="M9 8 12 5l3 3" /><path d="M9 16 12 19l3-3" /><path d="M8 9 5 12l3 3" /><path d="M16 9 19 12l-3 3" /></svg> Add Divider
        </button>
        <button
          type="button"
          ...
          title="Drag onto a spot in the list, or click to add at the top"
        >
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 5v14M5 12h14" /><path d="M9 8 12 5l3 3" /><path d="M9 16 12 19l3-3" /><path d="M8 9 5 12l3 3" /><path d="M16 9 19 12l-3 3" /></svg> Add Space
        </button>
      </div>
              ...
              >
                <div className={styles.rail}>
                  <span
                    ...
                    aria-hidden="true"
                  ><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 5v14M5 12h14" /><path d="M9 8 12 5l3 3" /><path d="M9 16 12 19l3-3" /><path d="M8 9 5 12l3 3" /><path d="M16 9 19 12l-3 3" /></svg></span>
