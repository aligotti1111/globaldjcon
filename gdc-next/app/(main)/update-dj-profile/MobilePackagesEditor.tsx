                    ...
                    {myTypes.map((t) => {
                      ...
                      return (
                        <button
                          ...
                          style={{ ...sideItem(active), display: 'block', position: 'relative', overflow: 'visible', boxSizing: 'border-box', height: 42, paddingTop: '.35rem', paddingBottom: 0, paddingRight: '1.15rem' }}
                        >
