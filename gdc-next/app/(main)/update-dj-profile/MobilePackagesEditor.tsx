...
export default function MobilePackagesEditor({
  ...
  const sideItem = (active: boolean): CSSProperties => ({
    ...
    fontFamily: "'Bebas Neue', sans-serif", fontSize: '1.35rem', lineHeight: 1.05, letterSpacing: '.05em', textTransform: 'uppercase',
                    ...
                    {myTypes.map((t) => {
                      ...
                      return (
                        <button
                          ...
                          style={{ ...sideItem(active), display: 'block', position: 'relative', overflow: 'visible', boxSizing: 'border-box', height: 50, paddingTop: '.4rem', paddingBottom: 0, paddingRight: '1.2rem' }}
                        >
