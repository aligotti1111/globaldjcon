          ...
          {(!activeSection || activeSection === 'rates') && (
            <div className={styles.sectionCard} style={{ marginBottom: 0, borderBottom: 'none', borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }}>
              <SectionBanner
                icon="rates"
                title="Equipment"
                subtitle="Pick what you bring — your rates below tie to this."
              />
          ...
          {(!activeSection || activeSection === 'rates') && (
            <div className={styles.sectionCard} style={{ borderTopLeftRadius: 0, borderTopRightRadius: 0 }}>
              <SectionBanner
                icon="rates"
                title="Rates"
                subtitle="Your default rates. Override per-day from the calendar."
              />
              <div className={styles.sectionBody}>
                {!hasEquipSelected ? (
                  <p className={styles.bodyHint}>
          ...
          {(!activeSection || activeSection === 'settings') && (
            <div className={styles.sectionCard}>
              <SectionBanner
                icon="settings"
                title="Settings"
                subtitle="Currency, booking window, deposit and tax."
              />
              <div className={styles.sectionBody}>
          ...
          {(!activeSection || activeSection === 'rider') && (
            <div className={styles.sectionCard}>
              <SectionBanner
                icon="rider"
                title="DJ Rider"
                subtitle="Your default rider — customised per booking, sent to the host."
              />
              <div className={styles.sectionBody}>
                <div className={styles.settingRow}>
                  <div className={styles.settingLabelWrap}>
          ...
          {(!activeSection || activeSection === 'guests') && (
            <div className={styles.sectionCard}>
              <SectionBanner
                icon="guests"
                title="Guest List"
                subtitle="Collect names for the door, with plus-ones and a head count."
              />
              <div className={styles.sectionBody}>
                <div className={styles.settingRow}>
                  <div className={styles.settingLabelWrap}>
