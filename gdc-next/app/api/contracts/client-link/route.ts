...
export async function POST(req: Request) {
  ...
  // TEAM SEATS: a teammate reaches the owner's booking (dj_id === acting.djId);
  // the host is their own account (requester_id === user.id). Keying only to
  // user.id 403'd teammates trying to copy the client signing link.
